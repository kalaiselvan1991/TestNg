...
public class Projectjan06 extends BaseClass {
...
private void afterClass() {
	...
	private void login(@Optional("kalaiselvan123") String user,@Optional("kalai1991") String pass) throws InterruptedException {
...
launchUrl("http://adactinhotelapp.com/index.php");
	...
	private void booking(@Optional("15/01/2022")String in,@Optional("18/01/2022")String out) throws InterruptedException {
...
CheckingPage c=new CheckingPage();
	...
	private void address(@Optional("KALAISELVAN")String name,@Optional("THANGASAMY")String lname,@Optional("pammal chennai tamilnadu")String address,@Optional("4594459545944594")String ccno,@Optional("123")String cvv) throws InterruptedException {
