...
public class ProjectJan10 extends BaseClass {
	...
	private void afterClass() {
		...
		@Test(priority = 2,dataProvider ="login",dataProviderClass = MethodsForAddatin.class)
	...
	CheckingPage c=new CheckingPage();
		...
		@Test(priority = 5 ,dataProvider = "login",dataProviderClass = MethodsForAddatin.class)
