...
public class ProjectJan11new extends BaseClass{
...
private void afterClass() {
	...
	@Test(groups = "smoke" ,dataProvider = "login",dataProviderClass = MethodsForAddatin.class)
	...
	clickbtn(h.getBtnlogin());
		...
		@Test(groups = "sanity",dataProvider = "address",dataProviderClass = MethodsForAddatin.class)
		...
		@Test(groups = "retest" ,dataProvider = "booking",dataProviderClass = MethodsForAddatin.class)
		...
		@Test(groups = "smoke" ,dataProvider = "date",dataProviderClass = MethodsForAddatin.class)
